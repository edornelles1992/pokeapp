...
de pokemons disponíveis para que ele possa escolher. Por ultimo após selecionar
o pokemon ele é enviado para a tela de detalhes onde mostra informações gerais 
do pokemon (peso, altura, habilidades) e disponibiliza a opcão do usuário compar-
tilhar as informações do pokemon.
...
Models - Pacote que guardam as entidades do projeto.
